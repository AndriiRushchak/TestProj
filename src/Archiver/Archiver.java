...
public class Archiver {
    public static void main(String[] args) throws IOException {
        ...
        do {
            try {
                ...
                ConsoleHelper.writeMessage("Ви не вибрали файл архіву або вибрали невірний файл.");
            } catch (Exception e) {
                ConsoleHelper.writeMessage("Виникла помилка. Перевірте введені дані.");
            }
    ...
    public static Operation askOperation() throws IOException {
        ...
        ConsoleHelper.writeMessage(String.format("\t %d - додати файл в архів", Operation.ADD.ordinal()));
